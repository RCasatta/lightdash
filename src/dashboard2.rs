...
mod tests {
    ...
    fn generates_site_from_snapshot_contract() {
        ...
        fs::write(
            ...
            br#"[{"amount_sat":1000,"rank":1,"node_id":"02candidate","alias":"candidate","connectable":true,"had_channel_in_past":true,"appearances":4,"appearance_ratio":0.57,"average_fee_ppm":100.0,"fee_diversity":0.1,"channel_count":10}]"#,
        )
        .unwrap();
        fs::write(
